...
(function () {
  ...
  function init(root) {
    ...
    root.querySelectorAll("[data-ts]").forEach(el => { const d = new Date(el.dataset.ts * 1000); el.textContent = el.dataset.fmt === "date" ? d.toLocaleDateString("pt-BR") : el.dataset.fmt === "time" ? "às " + d.toLocaleTimeString("pt-BR", { hour: "2-digit", minute: "2-digit" }) : d.toLocaleString("pt-BR"); });
