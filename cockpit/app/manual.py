...
PLAYER = {
    ...
    "!reset": ("!reset", "Volta pro level 1 e ganha um bônus permanente de vida e mana (quando o Mestre liberar).", "Diversão"),
...
HOWTO = {
    ...
    "/reset": "Reset de progresso: liga ou desliga o !reset (volta pro level 1 com um bônus permanente de vida e mana), nível mínimo, limite de resets e o tamanho do bônus. Mostra quem já resetou.",
